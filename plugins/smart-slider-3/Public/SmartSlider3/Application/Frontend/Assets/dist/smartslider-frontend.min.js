! function(t) {
    ...
    j((function() {
        ...
        return t.prototype.whenLoaded = function() {
            ...
            this.layer = t.layer, this.slide = this.slider.findSlideByElement(this.playerElement), this.isStatic = this.slide.isStatic();
            var s = {
                enablejsapi: 1,
            ...
            this.cover && (n2const.isMobile && T(this.cover, "click", this.play.bind(this)), T(this.layerElement, "n2play", this.fadeOutCover.bind(this))), this.slider.stages.done("BeforeShow", this.onBeforeShow.bind(this))
