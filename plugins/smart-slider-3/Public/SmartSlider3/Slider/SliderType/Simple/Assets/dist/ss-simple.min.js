! function(t) {
    ...
    ! function(t) {
        ...
        return t.prototype = Object.create(a.SmartSliderResponsive.prototype), t.prototype.constructor = t, t.prototype.init = function() {
            ...
            if (this.resizeContext.slideOuterWidth = h.width, this.resizeContext.slideOuterHeight = h.height, a.SmartSliderResponsive.prototype.calculateResponsiveValues.call(this), this.xt) {
