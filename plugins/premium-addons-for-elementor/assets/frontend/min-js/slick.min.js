! function() {
    ...
    n.fn.animate = function(e, i, t, o) {
        ...
        return s.complete = s.old, this.each(function() {
            this[r] || (this[r] = l++);
            var i = n.extend({}, s);
            a.apply(n(this), [e, n.extend({}, i)]), d[this[r]] = {
                run: !0,
                prop: e,
                opt: i,
                start: c(),
        ...
        return this.each(function() {
            this[r] || (this[r] = l++);
            var i = d[this[r]];
            i && i.run && (i.done += c() - i.start, i.done > i.opt.duration ? delete d[this[r]] : (n(this).stop(), i.run = !1))
        })
    }, n.fn.resume = function() {
        return this.each(function() {
            this[r] || (this[r] = l++);
            var i = d[this[r]];
            i && !i.run && (i.opt.duration -= i.done, i.done = 0, i.run = !0, i.start = c(), a.apply(n(this), [i.prop, n.extend({}, i.opt)]))
        })
    }
}(),
function(i) {
    ...
    s = 0, (r = function(i, e) {
        ...
        if (o.animateHeight(), !0 === o.options.rtl && !1 === o.options.vertical && (i = -i), !1 === o.transformsEnabled) !1 === o.options.vertical ? o.$slideTrack.animate({
            ...
            !0 === o.options.variableWidth && !1 === o.options.vertical && (s = o.options.speed * d(o.$slides.get(o.currentSlide - 1)).data("slick-width-factor")), o.myAnimation = o.$slideTrack.prop({
        ...
        if (i.$slides.each(function(i, e) {
                d(e).attr("data-slick-index", i).data("originalStyling", d(e).attr("style") || ""), t.push(d(e).outerWidth())
            }), !0 === i.options.variableWidth && !1 === i.options.vertical) {
            var o = Math.max.apply(null, t);
            i.$slides.each(function(i, e) {
                d(e).attr("data-slick-width-factor", t[i] / o)
            })
        }
